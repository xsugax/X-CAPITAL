...
export type ButtonVariant = 'primary' | 'secondary' | 'danger' | 'ghost' | 'gold' | 'outline';
...
const VARIANT_CLASSES: Record<ButtonVariant, string> = {
  primary:
    'bg-xc-purple hover:bg-purple-600 active:bg-purple-700 text-white border border-purple-600/50 shadow-lg shadow-purple-900/30',
  secondary:
  ...
  gold:
    'bg-amber-600/80 hover:bg-amber-500 active:bg-amber-600 text-white border border-amber-500/50 shadow-lg shadow-amber-900/30',
  outline:
    'bg-transparent hover:bg-xc-purple/10 text-xc-purple-light border border-purple-600/50 hover:border-purple-500',
};
