  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-[1fr_repeat(4,_auto)] gap-2 md:gap-4 px-3 mb-2">
        ...
        <span className="text-xs text-xc-muted font-medium text-right hidden sm:block">Avg Cost</span>
        <span className="text-xs text-xc-muted font-medium text-right">Value</span>
            ...
            >
              ...
              <div className="flex items-center gap-2 min-w-0">
                ...
                <div className="min-w-0">
                  ...
                  <div className="text-xs text-xc-muted truncate max-w-[80px] md:max-w-none">{holding.asset?.name}</div>
                </div>
              </div>
