      ...
      <div className="space-y-8">
        ...
        <div className="relative overflow-hidden rounded-2xl border border-xc-border min-h-[200px]">
          ...
          <div className="absolute inset-0">
            <Image
              src="https://images.unsplash.com/photo-1617704548623-340376564e68?w=3840&q=95&auto=format&fit=crop"
        ...
        {teslaProducts.length > 0 && (
          <section>
            ...
            <div className="relative h-48 rounded-2xl overflow-hidden mb-5 border border-red-900/20">
              <Image
                src="https://images.unsplash.com/photo-1560958089-b8a1929cea89?w=3840&q=95&auto=format&fit=crop"
        ...
        {spaceProducts.length > 0 && (
          <section>
            ...
            <div className="relative h-44 rounded-2xl overflow-hidden mb-5 border border-indigo-900/20">
              <Image
                src="https://images.unsplash.com/photo-1541185200-8de3ab08bcf8?w=3840&q=95&auto=format&fit=crop"
                alt="Rocket launch"
                fill
                className="object-cover object-center"
                unoptimized
...
const DEMO_PRODUCTS: Product[] = [
  // â”€â”€ Tesla lineup â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  {
    ...
    imageEmoji: "ðŸš—",
    imageUrl:
      "https://images.unsplash.com/photo-1617704548623-340376564e68?w=3840&q=95&auto=format&fit=crop",
  ...
  },
  {
    ...
    imageEmoji: "ðŸŽï¸",
    imageUrl:
      "https://images.unsplash.com/photo-1560958089-b8a1929cea89?w=3840&q=95&auto=format&fit=crop",
  ...
  },
  {
    ...
    imageEmoji: "ðŸš™",
    imageUrl:
      "https://images.unsplash.com/photo-1561580125-028ee3bd62eb?w=3840&q=95&auto=format&fit=crop",
  ...
  },
  {
    ...
    imageEmoji: "ðŸš",
    imageUrl:
      "https://images.unsplash.com/photo-1619642975990-fc74996d8be2?w=3840&q=95&auto=format&fit=crop",
  ...
  },
  {
    ...
    imageEmoji: "ðŸ›»",
    imageUrl:
      "https://images.unsplash.com/photo-1585087591762-99f98700b56d?w=3840&q=95&auto=format&fit=crop",
    imageAlt: "Tesla Cybertruck stainless steel",
  ...
  },
  {
    ...
    imageEmoji: "ðŸ›°ï¸",
    imageUrl:
      "https://images.unsplash.com/photo-1516849677043-ef67c9557e16?w=3840&q=95&auto=format&fit=crop",
  ...
  },
  {
    ...
    imageEmoji: "ðŸ’»",
    imageUrl:
      "https://images.unsplash.com/photo-1517336714731-489689fd1ca8?w=3840&q=95&auto=format&fit=crop",
